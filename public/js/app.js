...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/orders/admin", {
    headers: {
...
function updateCart(menuItem) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/cart", menuItem).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var menuItem = JSON.parse(btn.dataset.menu);
    updateCart(menuItem);
  });
}); // Change order status
...
__webpack_require__(/*! C:\Users\Abdellatif\Desktop\Projects\Food_Delivery\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Abdellatif\Desktop\Projects\Food_Delivery\resources\scss\app.scss */"./resources/scss/app.scss");
